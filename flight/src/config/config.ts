...
export const config = {
    ...
    MONGO_URI: process.env.MONGO_URI || "mongodb+srv://royu49:rajbeer11@cluster0.pjdlrpz.mongodb.net/?retryWrites=true&w=majority",
    ...
    //  MONGO_URI_TESTING : mongodb+srv://admin:FYv5jqnidHPCxCOr@testing.s5sej.mongodb.net/testing?retryWrites:true&w:majority,
